...
QT_MOC_LITERAL(1, 11, 11), // "newLogReady"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 3), // "msg"
QT_MOC_LITERAL(4, 28, 11) // "onReadyRead"

    },
    "LogManager\0newLogReady\0\0msg\0onReadyRead"
};
...
void LogManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newLogReady((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (LogManager::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LogManager::newLogReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LogManager::newLogReady(QString _t1)
{
