...
//     if (lastSlash != -1) file = file.mid(lastSlash + 1);
    
//     QString line = QString::number(context.line ? context.line : 0);

//     // 4. 拼装最终的日志字符串: "2026-04-20 12:00:00.123 [INFO ] main.cpp:45 - Hello World"
//     QString logMessage = QString("%1 %2 %3:%4 - %5").arg(timeStr, levelStr, file, line, msg);
